  ...
  const reviewItems = [
    {
      ...
      review:
        "This platform helped me find the perfect role in just two weeks! The matching algorithm is incredibly accurate.",
      rating: 5,
    },
    {
      ...
      review:
        "After struggling with other job sites, I found my dream developer position through this platform. The process was seamless.",
      rating: 5,
    },
    {
      ...
      review:
        "The quality of job listings is outstanding. I connected with employers who truly valued my skills and experience.",
      rating: 4,
    },
    {
      ...
      review:
        "The salary insights feature helped me negotiate a better offer. I'm earning 15% more than I expected!",
      rating: 5,
    },
    {
      ...
      review:
        "The resume builder tool transformed my application. I started getting callbacks immediately after using it.",
      rating: 4,
    },
    {
      ...
      review:
        "I've recommended this platform to everyone in my network. It's simply the best job search experience available.",
      rating: 5,
    },
    {
      ...
      review:
        "As a recruiter, I've found exceptional talent through this platform. The candidate matching is spot on.",
      rating: 5,
    },
  ];
  ...
  return (
    <div className="mt-16 mb-20 bg-gray-50 py-12 px-4">
      ...
      <p className="text-center text-gray-600 mb-10">
        Thousands of professionals have found their dream jobs using our
        platform
      </p>
      ...
      >
        ...
        <div
          ...
          style={{
            transform: `translateX(-${(activeIndex + totalItems) * (100 / visibleCards)}%)`,
          }}
        >
            ...
            >
              ...
              <div className="bg-white rounded-xl border border-gray-200 shadow-md h-full overflow-hidden transition-all duration-300 hover:shadow-lg hover:scale-[1.02] pt-16 px-5 pb-5">
                ...
                <div className="flex-1 flex flex-col">
                  ...
                  {/* Review text */}
                  <p className="text-gray-700 mb-5 italic flex-1">
                    {item.review}
                  </p>
