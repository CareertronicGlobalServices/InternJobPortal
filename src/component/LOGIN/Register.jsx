...
const Register = () => {
  return (
    <div className="flex w-full h-screen flex-col md:flex-row overflow-hidden bg-white">
      <Welcome />
      <Form />
      <ToastContainer
        position="top-right"
...
const Welcome = () => (
  <div 
    className="w-full md:w-3/5 h-64 md:h-screen flex items-center justify-center bg-cover bg-center"
...
const Form = () => {
  ...
  return (
    <div className="w-full h-3/5 md:h-full md:w-2/5 flex flex-col justify-center items-center px-4 md:px-2 overflow-y-auto bg-white">
      <div
        className="flex flex-col gap-2 w-full max-w-sm[30rem] p-5 rounded-2xl relative bg-white text-black my-4"
        style={{ height: "62%" }}
      >
        ...
        <form onSubmit={handleRegister} className="flex flex-col h-full">
          ...
          <div className="flex w-full gap-2 mb-2 py-4">
            <div className="relative w-1/2 group">
              <input
                className="bg-white text-black  w-full pt-5 pb-1 px-3 outline-none border border-red-600/40 rounded-lg focus:border-red-400 text-base peer"
                type="text"
                name="firstName"
            ...
            <div className="relative w-1/2 group">
              <input
                className="bg-white text-black/70 w-full pt-5 pb-1 px-3 outline-none border border-red-600/40 rounded-lg focus:border-red-400 text-base peer"
                type="text"
                name="lastName"
                ...
                required
              />
              <span className={`text-black/50 absolute left-3 top-3 text-sm transition-all duration-300 pointer-events-none peer-placeholder-shown:top-3 peer-placeholder-shown:text-base peer-focus:top-1 peer-focus:text-xs peer-focus:font-semibold peer-focus:text-red-400 ${formData.lastName ? "opacity-0" : "group-hover:opacity-0"}`}>
                lastName
              </span>
            </div>
          </div>
          ...
          <div className="relative mb-4 group">
            <input
              ...
              required
            />
            <span className={`text-black/50 absolute left-3 top-3 text-sm transition-all duration-300 pointer-events-none peer-placeholder-shown:top-3 peer-placeholder-shown:text-base peer-focus:top-1 peer-focus:text-xs peer-focus:font-semibold peer-focus:text-red-400 ${formData.email ? "opacity-0" : "group-hover:opacity-0"}`}>
              email
            </span>
          </div>
          ...
          <div className="relative mb-4 group">
            <input
              ...
              required
            />
            <span className={`text-black/50 absolute left-3 top-3 text-sm transition-all duration-300 pointer-events-none peer-placeholder-shown:top-3 peer-placeholder-shown:text-base peer-focus:top-1 peer-focus:text-xs peer-focus:font-semibold peer-focus:text-red-400 ${formData.phone ? "opacity-0" : "group-hover:opacity-0"}`}>
              Phone
            </span>
          </div>
          ...
          <div className="relative mb-4 group">
  <select
    className="bg-white text-black w-full pt-5 pb-1 px-3 outline-none border border-red-600/40 rounded-lg focus:border-red-400 text-base appearance-none peer"
    name="role"
    value={formData.role}
    onChange={handleChange}
    required
  ...
  <span
    className={`text-black/50 absolute left-3 top-3 text-sm transition-all duration-300 pointer-events-none peer-focus:top-1 peer-focus:text-xs peer-focus:font-semibold peer-focus:text-red-400 ${
    ...
    >
      ...
      ></path>
          ...
          <div className="relative mb-4 group">
            ...
            <button
              type="button"
              className="absolute right-3 top-4 text-black/50 hover:text-red-400 text-xs"
          ...
          <div className="relative mb-4 group">
            ...
            <button
              type="button"
              className="absolute right-3 top-3 text-black/50 hover:text-red-400 text-xs"
