  ...
  return (
    <section className="bg-gradient-to-b from-gray-100 to-white py-12 px-4 md:px-8 lg:px-16">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Search Bar */}
        <div className="bg-white rounded-lg shadow-md p-8 flex flex-col md:flex-row mb-12 border border-gray-200">
              ...
              <div className="flex whitespace-nowrap animate-marquee1">
                {[...companies, ...companies, ...companies].map((company, index) => (
                  <div key={`company-1-${index}`} className="mx-4 inline-flex items-center">
                    <div className="bg-white p-3 rounded shadow-sm border border-gray-200 h-12 flex items-center">
        ...
        <div className="bg-mint-100 rounded-lg p-8 flex flex-col md:flex-row items-center justify-between shadow-md mb-12 border border-gray-200">
          {/* Left Side - Image/People Section */}
          <div className="flex items-center space-x-4 mb-6 md:mb-0 md:w-1/2">
            <Image
              src="/Jobportal/hire.png"
              alt="Businessman"
              width={500}
              height={500}
